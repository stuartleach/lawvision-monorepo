...
<div class="mx-2 grid grid-rows-2 sm:rounded-none first:rounded-l-2xl last:rounded-r-2xl rounded-2xl bg-zinc-950/50 w-full justify-center px-6 py-6 sm:px-6 lg:px-8">
