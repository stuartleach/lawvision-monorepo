...
<LawCard>
	...
	<h4
		class="text-xl tracking-tight font-bold text-gray-500 mb-1">{selectedJudgeInfo?.name ? "Racial Breakdown" : ""}</h4>
	...
	<div>
		<ScrollableList>
			<ClickableListItem>
				...
				<p slot="stat">
					{$selectedJudgeRaceOutcomesStore?.['American Indian/Alaska Native'].pct.release}
				</p>
			</ClickableListItem>
