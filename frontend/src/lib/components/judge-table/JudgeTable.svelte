...
<div class="grid bg-zinc-900 pb-5 pt-16">
	...
	<div class="table-container mt-6 flex overflow-x-auto h-screen">
		<table class="mt-6 w-full whitespace-nowrap text-left h-screen">
			<colgroup>
				<col class="lg:w-1/12" />
				<col class="lg:w-3/12" />
				<col class="lg:w-2/12" />
			...
			<tbody class="divide-y divide-white/5 h-screen">
