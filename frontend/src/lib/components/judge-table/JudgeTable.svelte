...
<div class="grid max-h-[97vh] bg-zinc-900 pb-5 pt-16">
	...
	<div class="mt-6 flex overflow-x-auto">
		<table class="mt-6 w-full whitespace-nowrap text-left">
			...
			<thead class="sticky top-0 mb-4 bg-zinc-900 text-base leading-6 text-zinc-400">
				<tr>
				...
				<div class="absolute mb-2 w-screen border-b-2 border-white/10 bg-zinc-900"></div>
			</thead>
