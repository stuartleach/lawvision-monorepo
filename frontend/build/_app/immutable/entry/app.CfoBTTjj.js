const __vite__fileDeps = [
		'../nodes/0.D9rYwdbB.js',
		'../chunks/scheduler.DUZ9pEMT.js',
		'../chunks/index.B2RTt-ug.js',
		'../assets/0.BIa1EDYO.css',
		'../nodes/1.CIZDybJ1.js',
		'../chunks/entry.CUXILA0h.js',
		'../chunks/index.D7TgaCnU.js',
		'../nodes/2.JNmFb81l.js',
		'../assets/2.DuTTJU0P.css',
		'../nodes/3.CJCJedtp.js',
		'../nodes/4.DOKCf3BC.js'
	],
	__vite__mapDeps = (i) => i.map((i) => __vite__fileDeps[i]);
import { s as N, a as B, o as U, b as D, t as j } from '../chunks/scheduler.DUZ9pEMT.js';
import {
	S as W,
	i as z,
	s as F,
...
const ae = [
		() => L(() => import('../nodes/0.D9rYwdbB.js'), __vite__mapDeps([0, 1, 2, 3]), import.meta.url),
		() =>
			L(() => import('../nodes/1.CIZDybJ1.js'), __vite__mapDeps([4, 1, 2, 5, 6]), import.meta.url),
		() =>
			L(() => import('../nodes/2.JNmFb81l.js'), __vite__mapDeps([7, 6, 1, 2, 8]), import.meta.url),
		() => L(() => import('../nodes/3.CJCJedtp.js'), __vite__mapDeps([9, 1, 2]), import.meta.url),
		() => L(() => import('../nodes/4.DOKCf3BC.js'), __vite__mapDeps([10, 1, 2]), import.meta.url)
	],
	le = [],
	fe = { '/': [2], '/about': [3], '/contact': [4] },
	ce = {
		handleError: ({ error: a }) => {
			console.error(a);
		},
