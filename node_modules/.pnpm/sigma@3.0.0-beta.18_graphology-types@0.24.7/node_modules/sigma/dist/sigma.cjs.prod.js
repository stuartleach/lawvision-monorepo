...
var inherits = require('./inherits-fd41da79.cjs.prod.js');
var index = require('./index-df506141.cjs.prod.js');
var types_dist_sigmaTypes = require('../types/dist/sigma-types.cjs.prod.js');
var normalization = require('./normalization-f50da95f.cjs.prod.js');
var colors = require('./colors-d415fc58.cjs.prod.js');
...
var Camera = /*#__PURE__*/function (_TypedEventEmitter) {
  ...
  inherits._createClass(Camera, [{
    ...
    value: function animate(state, opts, callback) {
      ...
      var options = Object.assign({}, normalization.ANIMATE_DEFAULTS, opts);
      var validState = this.validateState(state);
...
function _arrayWithoutHoles(arr) {
  if (Array.isArray(arr)) return colors._arrayLikeToArray(arr);
}
...
function _toConsumableArray(arr) {
  return _arrayWithoutHoles(arr) || _iterableToArray(arr) || colors._unsupportedIterableToArray(arr) || _nonIterableSpread();
}
...
var Sigma$1 = /*#__PURE__*/function (_TypedEventEmitter) {
  ...
  function Sigma(graph, container) {
    ...
    for (var type in _this.settings.nodeProgramClasses) {
      ...
      _this.nodePrograms[type] = new NodeProgramClass(_this.webGLContexts.nodes, _this.frameBuffers.nodes, inherits._assertThisInitialized(_this));
      ...
      _this.nodeHoverPrograms[type] = new NodeHoverProgram(_this.webGLContexts.hoverNodes, null, inherits._assertThisInitialized(_this));
    }
    for (var _type in _this.settings.edgeProgramClasses) {
      var EdgeProgramClass = _this.settings.edgeProgramClasses[_type];
      _this.edgePrograms[_type] = new EdgeProgramClass(_this.webGLContexts.edges, _this.frameBuffers.edges, inherits._assertThisInitialized(_this));
    }
  ...
  inherits._createClass(Sigma, [{
    ...
    value: function createCanvas(id) {
      var canvas = normalization.createElement("canvas", {
        position: "absolute"
      }, {
    ...
    value: function process() {
      ...
      var nullCameraMatrix = normalization.matrixFromCamera(nullCamera.getState(), dimensions, this.getGraphDimensions(), this.getSetting("stagePadding") || 0);
    ...
    value: function framedGraphToViewport(coordinates) {
      ...
      var matrix = override.matrix ? override.matrix : recomputeMatrix ? normalization.matrixFromCamera(override.cameraState || this.camera.getState(), override.viewportDimensions || this.getDimensions(), override.graphDimensions || this.getGraphDimensions(), override.padding || this.getSetting("stagePadding") || 0) : this.matrix;
    ...
    value: function viewportToFramedGraph(coordinates) {
      var override = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var recomputeMatrix = !!override.cameraState || !!override.viewportDimensions || !override.graphDimensions;
      var invMatrix = override.matrix ? override.matrix : recomputeMatrix ? normalization.matrixFromCamera(override.cameraState || this.camera.getState(), override.viewportDimensions || this.getDimensions(), override.graphDimensions || this.getGraphDimensions(), override.padding || this.getSetting("stagePadding") || 0, true) : this.invMatrix;
    ...
    value: function getCanvases() {
      return index._objectSpread2({}, this.elements);
    }
  }]);
  return Sigma;
}(types_dist_sigmaTypes.TypedEventEmitter);
